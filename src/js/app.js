...
function iniciarApp() {
    ...
    consultarAPI(); //Comsulta la API, en el backend 
...
function mostrarSeccion () {
    //Ocultar la seccion que tenag la clase mostrar
...
function mostrarResumen () {
    ...
    if(Object.values(cita).includes('') || cita.servicios.length === 0) {
        mostrarAlerta('Faltan datos de Servicios, Fecha u Horario', 'error', '.contenido-resumen', false);
    ...
    //Heading ara servicios en resumen
